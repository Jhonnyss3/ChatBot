        ...
        public async Task<string> RespondAsync(string message, string? sessionId = null)
        {
            ...
            switch (intent)
            {
                case Intent.Historia:
                    ...
                    return "A FURIA Esports foi fundada em 2017 com a missão de se tornar uma potência no cenário de CS:GO. Desde o começo, a equipe se destacou por sua energia e estilo de jogo agressivo, ganhando rapidamente espaço no Brasil e no mundo.\r\nEm 2019, o time brilhou ao derrotar grandes nomes, como a Astralis, e se consolidou como uma das principais equipes do Brasil. A chegada de FalleN em 2023 trouxe ainda mais força ao nosso elenco, reforçando a busca por títulos e a ambição de continuar sendo referência no cenário internacional.\r\nHoje, a FURIA segue firme, representando o Brasil no mundo do CS:GO e mostrando sua garra em cada torneio.\nCaso queira saber mais sobre nossos Títulos, digite 'Títulos'.";
                case Intent.Titulos:
